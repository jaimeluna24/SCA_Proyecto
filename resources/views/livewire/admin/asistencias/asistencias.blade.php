<div>
    ...
    <div class="w-10/12 mx-auto mt-8">
        ...
        <div class="grid md:grid-cols-3 md:gap-6 md:mb-6">
            ...
            <div class="relative z-0 mb-5">
                <input value="{{ $asistenciaSelected->horario->clase->asignatura }}" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " disabled />
            ...
            <div class="relative z-0 mb-5">
                <input value="{{ $asistenciaSelected->horario->aula->nombre }}" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " disabled  />
        ...
        <div class="grid md:grid-cols-3 md:gap-6 md:mb-6">
            <div class="relative z-0 mb-5">
                <input value="{{ $asistenciaSelected->horario->tipo_aula->tipo }}" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " disabled />
                <label for="floating_standard" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">Tipo de aula</label>
            </div>
            <div class="relative z-0 mb-5">
                <input value="{{ $asistenciaSelected->fecha }}" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " disabled />
            ...
            <div class="relative z-0 mb-5">
                <input value="{{ $asistenciaSelected->horario->hora_inicio }} - {{ $asistenciaSelected->horario->hora_fin }}" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " disabled />
        ...
        <div class="grid md:grid-cols-2 md:gap-6 md:mb-6">
            <div class="relative z-0 mb-5">
                <input value="{{ $asistenciaSelected->observacion }}" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " disabled />
            ...
            <div class="relative z-0 mb-5">
                <input value="{{ $asistenciaSelected->link }}" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " disabled />
                <label for="floating_standard" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">Link de clase virtual</label>
            </div>
            @endif
        </div>
        ...
        <div class="flex flex-wrap mt-4">
            ...
            <button wire:click="modeFalta({{ $asistenciaSelected->id }})" type="button" class="focus:outline-none text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-900">Falta Justificada</button>
                ...
                <tbody>
                    @forelse ($asistencias as $item)
                        <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">{{ $item->horario->docente->nombre }} {{ $item->horario->docente->apellido }}</td>
                ...
                <li class="pb-3 sm:pb-4 mb-2">
                    <div class="flex items-center space-x-4 rtl:space-x-reverse">
                       <div class="flex-1 min-w-0">
                          ...
                          <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                         {{ $item->horario->aula->nombre }} - {{ $item->horario->hora_inicio }} - {{ $item->horario->tipo_aula->tipo }}
                          </p>
                       </div>
