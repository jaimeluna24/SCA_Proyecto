<div>
    ...
    <div class="border rounded-md p-5 bg-white dark:bg-transparent border-gray-200 dark:border-gray-600">
        ...
        <form wire:submit.prevent="register()" class="w-10/12 mx-auto mt-8 ">
            <div class="grid md:grid-cols-2 md:gap-6 md:mb-6">
                <div class="mb-3">
                    <label for="first_name"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Código de Clase</label>
                    <input wire:model="codigo" type="text" id="first_name"
                        class="{{ $errors->has('codigo') ? ' border-red-600' : '' }} bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required />
                    <div class="errors">
                        @error('codigo')
                            {{ $message }}
                ...
                <div class="mb-3">
                    <label for="first_name"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre de Clase</label>
                    <input wire:model="asignatura" type="text" id="first_name"
                        class="{{ $errors->has('asignatura') ? ' border-red-600' : '' }} bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required />
                    <div class="errors">
                        @error('asignatura')
                            {{ $message }}
            ...
            <div class="grid md:grid-cols-1 md:gap-6 md:mb-6">
                <div class="mb-3">
                    <label for="first_name"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asignar a carrera</label>
                    @foreach ($carreras as $item)
                    <div class="flex items-center mb-4">
                        <input wire:model="carrerasSeleccionadas" id="default-checkbox" type="checkbox" value="{{ $item->id }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label wire:target="carrerasSeleccionadas" for="default-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $item->carrera }}</label>
                    </div>
                    @endforeach
    ...
    @elseif($deshabilitar)
        <div
            ...
            <p class="text-sm font-normal text-gray-500 dark:text-gray-400"> ¿Estás seguro de eliminar la clase
                {{ $claseName }}?</p>
            <p class="text-sm font-normal text-gray-500 dark:text-gray-400"> Se perderan todos los registros adjuntos a la clase</p>


            <div class="flex mt-7">
                <button wire:click="eliminarClase()" type="button"
        ...
        <div class="border rounded-md p-5 bg-white dark:bg-transparent border-gray-200 dark:border-gray-600">
            ...
            <form class="w-10/12 mx-auto mt-8 ">
                <div class="grid md:grid-cols-2 md:gap-6 md:mb-6">
                    <div class="mb-3">
                        <label for="first_name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Codigo de la clase</label>
                        <input wire:model="codigo" type="text" id="first_name"
                            class="{{ $errors->has('codigo') ? ' border-red-600' : '' }} bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required />
                        <div class="errors">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div
            ...
            <div class="relative">
                ...
                <input wire:model.live="query" type="text" id="table-search"
                    ...
                    placeholder="Buscar por clase o código">
            </div>
        </div>
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @forelse ($clases as $item)
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="px-6 py-4">{{ $item->codigo }}</td>
                        <td class="px-6 py-4">{{ $item->asignatura }}</td>
                        <td class="px-3 py-2">
                            <button
