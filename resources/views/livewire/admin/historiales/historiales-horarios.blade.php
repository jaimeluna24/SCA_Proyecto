        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div
                ...
                <div class="flex gap-2">
                    ...
                    <div>
                        <select id="countries" wire:model.live="periodoSelected" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                          <option selected value="0">Todos</option>
                          @foreach ($periodos as $item)
                          <option value="{{ $item->id }}">{{ $item->nombre }} - {{ $item->anio }}</option>
                    ...
                    @forelse ($horarios as $item)
                        <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-3 py-2">
                                ...
                                <button  class="focus:outline-none text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-900" wire:click="modeDetalles({{ $item->id }})">
