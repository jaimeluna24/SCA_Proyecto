        ...
        <form  class="w-10/12 mx-auto mt-2">
            ...
            <div class="grid md:grid-cols-3 md:gap-6 md:mb-4">
                ...
                <div class="w-full mb-3">
                    ...
                    <input value="{{ $horario->periodo->nombre }} - {{ $horario->periodo->identificador }} - {{ $horario->periodo->anio }}" type="text" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled>
