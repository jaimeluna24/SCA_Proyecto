<div>
    ...
    @elseif ($changeRole)
        <div
            ...
            <form class="max-w-sm mx-auto">
                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Seleccionar
                    nuevo rol</label>
                <select wire:model.live="role_id" id="countries"
            ...
            <div class="flex mt-7">
                <button wire:click="cambiarRole()" type="button"
                    class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">Cambiar
                    rol</button>
                <button wire:click="modeList()" type="button"
                    class="text-white bg-gray-600 border border-gray-300 focus:outline-none hover:bg-gray-500 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-600 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Cancelar</button>
            </div>
    ...
    @elseif($modeChangeEstado)
        <div
            ...
            @if ($estado == 1)
                <p class="text-sm font-normal text-gray-500 dark:text-gray-400"> ¿Estás seguro de inactivar al usuario
                    {{ $username }}?</p>
            @else
                <p class="text-sm font-normal text-gray-500 dark:text-gray-400"> ¿Estás seguro de activar al usuario
                    {{ $username }}?</p>
            @endif
            ...
            <div class="flex mt-7">
                @if ($estado == 1)
                    <button wire:click="changeEstado()" type="button"
                        class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Inactivar</button>
                @else
                    <button wire:click="changeEstado()" type="button"
                        class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">Activar</button>
                @endif
                        ...
                        <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                <button type="button"
                                    ...
                                    wire:click="modeChangeRole({{ $item->id }})">Rol</button>

                                @if ($item->active == 1)
                                    <button
                                        class="focus:outline-none text-white bg-red-900 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-800 dark:hover:bg-red-900 dark:focus:ring-red-900"
                                        wire:click="modeEstado({{ $item->id }})">Inactivar</button>
                                @else
                                    <button
                                        ...
                                        wire:click="modeEstado({{ $item->id }})">Activar</button>
                                @endif
