...
<div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
    ...
    <p class="text-sm font-normal text-gray-500 dark:text-gray-400"> ¿Estás seguro de eliminar al usuario {{ $username }}?</p>
    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">  Se perderan todos los registros adjuntos al usuario</p>


   <div class="flex mt-7">
    <button wire:click="eliminarUsuario()" type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Eliminar</button>
    ...
    <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
        <h5 class="mb-3 text-base font-semibold text-gray-900 md:text-xl dark:text-white">
            Cambiar rol del usuario {{ $username }}
        </h5>
        Rol actual del usuario: <span style="font-weight: 800"> {{ $rolActual }}</span>



<form class="max-w-sm mx-auto">
    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Seleccionar nuevo rol</label>
    <select wire:model.live="role_id" id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
       ...
       <div class="flex mt-7">
        <button  wire:click="cambiarRole()" type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">Cambiar rol</button>
          <button  wire:click="modeList()" type="button" class="text-white bg-gray-600 border border-gray-300 focus:outline-none hover:bg-gray-500 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-600 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Cancelar</button>
    </div>
        </div>
      @elseif($modeChangeEstado)
      <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
        <h5 class="mb-3 text-base font-semibold text-gray-900 md:text-xl dark:text-white">
             Usuario: {{ $username }}
        </h5>
        @if ($estado == 1)
        <p class="text-sm font-normal text-gray-500 dark:text-gray-400"> ¿Estás seguro de inactivar al usuario {{ $username }}?</p>
        @else
        <p class="text-sm font-normal text-gray-500 dark:text-gray-400"> ¿Estás seguro de activar al usuario {{ $username }}?</p>
        @endif
        {{-- <p class="text-sm font-normal text-gray-500 dark:text-gray-400">  Se perderan todos los registros adjuntos al usuario</p> --}}

       <div class="flex mt-7">
        @if ($estado == 1)
        <button wire:click="changeEstado()" type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Inactivar</button>

        @else
        <button wire:click="changeEstado()" type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">Activar</button>
        ...
        <tbody>
            ...
            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td class="px-6 py-4">
                ...
                <button  class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" wire:click="modeDeshabilitar({{ $item->id }})">Eliminar</button></td>
