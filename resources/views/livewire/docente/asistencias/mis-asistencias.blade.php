            ...
            <div class="grid md:grid-cols-2 md:gap-6 md:mb-6">
                ...
                <div class="relative z-0 mb-5">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="default_size">
                        Evidencia</label>
                   <img src="{{ asset('storage/' . $asistenciaSelected->evidencia) }}" alt="">
                </div>
                        ...
                        @forelse ($asistencias as $item)
                            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-3 py-2">
                                        ...
                                        <button
                                            class="focus:outline-none text-white bg-gray-400 hover:bg-gray-500 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                                            wire:click="modeMarcarAsistencia({{ $item->id }})">Detalles</button>
