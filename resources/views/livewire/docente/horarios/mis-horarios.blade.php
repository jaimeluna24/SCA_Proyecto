        ...
        <form  class="w-10/12 mx-auto mt-2">
            ...
            <div class="flex justify-end gap-2">
                <button wire:click.prevent="modeList()"
                    class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Regresar</button>
