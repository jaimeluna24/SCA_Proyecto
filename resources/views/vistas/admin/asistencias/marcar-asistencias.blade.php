@extends('layout.app5')
@section('title')
<title>Marcar asistencias</title>
@stop
@section('header')
...
<span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Marcar Asistencias</span>
@stop
...
<ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Marcar</span>
...
@section('content')
    @livewire('admin.asistencias.marcar-asistencias')
@stop
