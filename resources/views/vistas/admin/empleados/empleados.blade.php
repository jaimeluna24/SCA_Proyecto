...
<span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Gestión de Empleados</span>
@stop
@section('button')
<a href="/empleados/registrar" type="button" class="flex focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-3 py-1.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">
...
<ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
      <div class="flex items-center">
        ...
        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Empleados</span>
