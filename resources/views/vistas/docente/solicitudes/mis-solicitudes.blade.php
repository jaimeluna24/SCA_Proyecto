...
<span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Mis Solicitudes</span>
@stop
@section('button')
<a href="/solicitudes/crear" type="button" class="flex focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-3 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">
...
<ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    <li class="inline-flex items-center" aria-current="page">
      ...
      <div class="flex items-center">
        ...
        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Mis Solicitudes</span>
      </div>
    </li>
  </ol>
@stop
